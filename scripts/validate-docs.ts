#!/usr/bin/env tsx
/**
 * CCNA StudyLab -- Documentation Validation Script
 *
...
/**
 * Validate that Python lab engine endpoints are documented.
 */
...
if (jsonMode) {
  ...
  console.log("  CCNA StudyLab -- Documentation Validation Report");
  console.log("=".repeat(70));
  console.log();
