# CCNA StudyLab -- Frontend Route Map
...
| Objectives per domain | `GET /api/study/progress` (DB with file fallback) | All 53 exam objectives |
...
| Filter tabs | Category filter (All, IOS CLI, Subnetting, Config Review, Python, ACL Builder) |
...
| Categories | Hardcoded enum | All, IOS CLI, Subnetting, Config Review, Python, ACL Builder |
...
| Category | Icon | Labs |
|----------|------|------|
| IOS CLI | Terminal | IOS Command Line exercises |
| Subnetting | Calculator | Subnetting practice |
| Config Review | FileSearch | Configuration review and troubleshooting |
| Python | Code2 | Python automation scripts |
| ACL Builder | Shield | Access Control List construction |
...
- **Score visualization** with circular badge (blue=pass, red=fail)
...
### Purpose
Conversational AI tutor powered by Claude (claude-sonnet-4-20250514). Students can ask questions about any CCNA exam topic, select a focus domain, and maintain conversation history.
...
| Domain | Focus Areas |
|--------|------------|
| Network Fundamentals (D1) | OSI/TCP-IP models, cabling, topology, IPv4/IPv6, wireless |
| Network Access (D2) | VLANs, trunking, EtherChannel, spanning tree, wireless |
| IP Connectivity (D3) | Routing concepts, OSPF, static routing, first-hop redundancy |
| IP Services (D4) | DHCP, DNS, NAT, NTP, SNMP, syslog, QoS |
| Security Fundamentals (D5) | ACLs, port security, AAA, VPN, wireless security |
| Automation and Programmability (D6) | REST APIs, configuration management, SDN, JSON, Python |
...
| About card | App version, exam blueprint version, Cisco CCNA link |
...
| Study preferences | `localStorage` (`ccna-settings` key) | Daily goal and batch size |
...
- **External link** to Cisco CCNA Associate certification page
