        ...
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="flex h-7 w-7 items-center justify-center rounded-md bg-blue-500/10 text-xs font-bold text-blue-500">
                {domain.number}
              </span>
            ...
            <Badge
              variant="secondary"
              className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-[11px] font-semibold shrink-0"
            >
              {domain.weight}%
            </Badge>
          </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Progress
              ...
              className="h-1.5 bg-zinc-800 [&>[data-slot=progress-indicator]]:bg-blue-500"
            />
          </div>
          ...
          {/* Go arrow */}
          <div className="flex items-center justify-end text-xs text-zinc-500 group-hover:text-blue-400 transition-colors">
