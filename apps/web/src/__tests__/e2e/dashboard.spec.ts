...
test.describe("Settings Page", () => {
  ...
  test("about section shows app version", async ({ page }) => {
    ...
    await expect(page.getByText("200-301 v1.1").first()).toBeVisible();
  });
  ...
  test("Cisco CCNA certification link exists", async ({ page }) => {
...
test.describe("Login Page", () => {
  test("login page renders with form fields", async ({ page }) => {
    ...
    await expect(page.getByText("CCNA StudyLab").first()).toBeVisible();
