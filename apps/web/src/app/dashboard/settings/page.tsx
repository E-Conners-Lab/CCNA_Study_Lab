...
export default function SettingsPage() {
  ...
  const userEmail = session?.user?.email ?? "student@ccna.lab";
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full h-2 rounded-full appearance-none bg-zinc-800 accent-blue-500 cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-500"
            />
      ...
      <Card className="border-zinc-800 bg-zinc-900/50">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between rounded-lg bg-zinc-800/50 px-4 py-3">
            ...
            <span className="text-sm font-mono text-zinc-300">200-301 v1.1</span>
          </div>
          <a
            href="https://www.cisco.com/site/us/en/learn/training-certifications/certifications/enterprise/ccna/index.html"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-lg bg-zinc-800/50 px-4 py-3 text-sm text-blue-400 hover:bg-zinc-800 transition-colors"
          >
