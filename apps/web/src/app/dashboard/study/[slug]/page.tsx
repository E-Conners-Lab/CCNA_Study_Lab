      ...
      >
        <CardHeader className="cursor-pointer hover:bg-zinc-800/30 transition-colors">
          <div className="flex items-center gap-3">
            <Badge
              variant="secondary"
              className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-xs font-mono shrink-0"
            >
              {topic.objectiveCode}
            </Badge>
              ...
              <div className="space-y-1.5">
                {topic.resources.map((resource, i) => (
                  <a
                    ...
                    className="flex items-center gap-2 text-sm text-zinc-400 hover:text-blue-400 transition-colors group rounded-md px-2 py-1.5 -mx-2 hover:bg-zinc-800/50"
                  >
                    <ExternalLink className="h-3.5 w-3.5 shrink-0 text-zinc-600 group-hover:text-blue-500 transition-colors" />
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div>
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-blue-400 transition-colors mb-4"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-500/10 text-lg font-bold text-blue-500 shrink-0">
              {guide.domain}
            </span>
          ...
          <Badge
            variant="secondary"
            className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-sm w-fit"
          >
