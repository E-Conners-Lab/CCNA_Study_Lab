        ...
        return (
          <button
            ...
            className={cn(
              ...
              answered && !isFlagged && !isCurrent && "bg-blue-500/80 text-zinc-950",
              !answered && !isFlagged && !isCurrent && "bg-zinc-700 text-zinc-300",
              isFlagged && isCurrent && "bg-amber-500/80 text-zinc-950 ring-2 ring-blue-400",
              answered && isCurrent && !isFlagged && "bg-blue-500/80 text-zinc-950"
            )}
          >
            {i + 1}
          </button>
  ...
  return (
    <div className="space-y-2">
      ...
      <Input
        ...
        disabled={disabled}
        className="bg-zinc-800/50 border-zinc-700 text-zinc-200 placeholder:text-zinc-600 focus-visible:border-blue-500/50 focus-visible:ring-blue-500/20"
      />
    </div>
  );
}
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span
                    className={cn(
                      ...
                      d.percentage >= 70 ? "text-blue-400" : "text-red-400"
                    )}
                  >
                ...
                <div className="h-2 w-full rounded-full bg-zinc-800 overflow-hidden">
                  <div
                    className={cn(
                      ...
                      d.percentage >= 70 ? "bg-blue-500" : "bg-red-500"
                    )}
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-4rem)]">
      ...
      <div className="shrink-0 px-4 pt-2">
        <Progress
          ...
          className="h-1 bg-zinc-800 [&>[data-slot=progress-indicator]]:bg-blue-500"
        />
      </div>
      ...
      <div className="flex flex-1 min-h-0 pt-2">
        ...
        <aside className="hidden lg:block w-56 shrink-0 border-r border-zinc-800 px-4 py-4">
          ...
          <div className="mt-4 space-y-1.5 text-[10px] text-zinc-500">
            ...
            <div className="flex items-center gap-2">
              <span className="h-3 w-3 rounded bg-blue-500/80 shrink-0" />
              Answered
            </div>
            <div className="flex items-center gap-2">
